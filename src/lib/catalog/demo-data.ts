...
export const DEMO_PRODUCTS: DemoProduct[] = [
  ...
  {
    id: "prod-6",
    canonical_name: "Умная колонка VK Капсула Про с Zigbee",
    brand: "VK",
    category: "Электроника",
    description:
      "Компактная колонка с голосовым помощником Маруся, LED-дисплеем с часами и встроенным хабом управления умным домом Zigbee. Мощность звука 24 Вт с технологией Room Correction.",
    image_url:
      "https://images.unsplash.com/photo-1543512214-318c7553f230?w=800&auto=format&fit=crop&q=80",
    ai_summary:
      "ИИ-анализ: Лидер продаж в категории умных колонок с экраном. Быстрый отклик Zigbee-устройств.",
    is_active: true,
    product_offers: [
      {
        id: "off-9",
        marketplace: "Ozon",
        title: "Умная колонка VK Капсула Про с Марусей и Zigbee, черный",
        url: "https://ozon.ru",
        price: 13990,
        currency: "RUB",
        rating: 4.9,
      ...
      },
      {
        id: "off-9-wb",
        marketplace: "Wildberries",
        title: "Умная колонка VK Капсула Про с Марусей, черная",
        url: "https://wildberries.ru",
        price: 13890,
        currency: "RUB",
        rating: 4.8,
  ...
  },
  {
    ...
    product_offers: [
      ...
      },
      {
        id: "off-22-wb",
        marketplace: "Wildberries",
        title: "Наушники Bowers & Wilkins Px8 кожа наппа",
        url: "https://wildberries.ru",
        price: 67990,
        currency: "RUB",
        rating: 4.8,
