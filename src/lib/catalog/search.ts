      ...
      offers: [
        {
          ...
          title: productTitle,
          url: isOzon ? buildOzonProductUrl(productTitle) : buildWildberriesProductUrl(id, productTitle),
          price: 2890,
          currency: "RUB",
          rating: 4.8,
          reviewCount: 940,
        ...
        },
        {
          ...
          title: productTitle,
          url: isOzon ? buildWildberriesProductUrl(id, productTitle) : buildOzonProductUrl(productTitle),
          price: 2950,
          currency: "RUB",
          rating: 4.7,
          reviewCount: 780,
