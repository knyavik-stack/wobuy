      ...
      <div className="mx-auto max-w-7xl">
        <header className="mb-8 flex flex-col gap-5 border-b border-white/10 pb-6 md:flex-row md:items-center md:justify-between">
          <div>
            ...
            <h1 className="mt-1 text-3xl font-extrabold tracking-tight text-white">{displayName ? `Привет, ${displayName}` : "Твоя рабочая область"}</h1>
