...
export default async function SearchPage({ searchParams }: { searchParams: Promise<{ q?: string; sort?: string; category?: string; view?: string }> }) {
  ...
  return <SearchResults query={query} products={products} categories={categories} category={category} sort={sort} view={view} />;
}
