...
export default function HeroSection() {
  ...
  return (
    <section className="relative min-h-screen w-full overflow-x-hidden bg-[#0D0F14] px-4 pb-12 pt-6 text-slate-100 selection:bg-[#00FF87] selection:text-black md:px-8 lg:px-16">
      ...
      <header className="sticky top-0 z-50 -mx-4 flex w-[calc(100%+2rem)] items-center justify-between border-b border-white/5 bg-[#0D0F14]/90 px-4 py-4 backdrop-blur-xl md:-mx-8 md:w-[calc(100%+4rem)] md:px-8 lg:-mx-16 lg:w-[calc(100%+8rem)] lg:px-16">
      ...
      <main className="relative z-10 mx-auto grid min-h-[calc(100vh-110px)] w-full max-w-7xl grid-cols-1 items-center gap-12 py-12 lg:grid-cols-12 lg:gap-8">
