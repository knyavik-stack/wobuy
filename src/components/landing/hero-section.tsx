...
export default function HeroSection() {
  ...
  return (
    <section className="relative min-h-screen w-full overflow-hidden bg-[#0D0F14] px-4 pb-12 pt-6 text-slate-100 selection:bg-[#00FF87] selection:text-black md:px-8 lg:px-16">
