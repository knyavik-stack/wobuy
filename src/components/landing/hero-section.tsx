        ...
        <div className="grid grid-cols-1 items-center gap-8 lg:grid-cols-12 lg:gap-12">
          ...
          <div className="flex flex-col space-y-4 lg:col-span-7">
            ...
            <h1 className="text-4xl font-extrabold tracking-tight text-white sm:text-5xl lg:text-6xl leading-[1.08]">
              Выбирает wobuy<span className="text-[#00FF87] drop-shadow-[0_0_8px_#00FF87]">.</span>
              <br />
            ...
            <p className="text-base sm:text-lg font-medium text-slate-300">
              Сервис честной селекции товаров wobuy<span className="text-[#00FF87] drop-shadow-[0_0_8px_#00FF87]">.</span>
            </p>
      ...
      >
        <div className="mb-8">
          ...
          <h2 className="mt-2 text-2xl font-black text-white sm:text-3xl lg:text-4xl tracking-tight">
            wobuy<span className="text-[#00FF87] drop-shadow-[0_0_8px_#00FF87]">.</span> — выбирает лучшее, отсекает лишнее
          </h2>
          <p className="mt-1.5 text-xs sm:text-sm text-slate-300 max-w-2xl">
            wobuy<span className="text-[#00FF87] drop-shadow-[0_0_8px_#00FF87]">.</span> за 3 минуты делает работу, на которую раньше уходили часы сравнений и сомнений.
          </p>
        </div>
            ...
            <div className="mt-5 rounded-2xl border border-white/5 bg-black/40 p-3.5 space-y-2 text-xs">
              ...
              <div className="flex items-center justify-between font-bold text-white">
                <span className="flex items-center gap-1.5 text-[#00FF87]">
                  ...
                  С wobuy<span className="text-[#00FF87] drop-shadow-[0_0_8px_#00FF87]">.</span>:
                </span>
          ...
          <div className="relative z-10 flex flex-col gap-8 lg:flex-row lg:items-center lg:justify-between">
            <div className="max-w-2xl space-y-4">
              <div className="inline-flex items-center gap-2 rounded-full border border-emerald-500/30 bg-emerald-500/10 px-3.5 py-1 text-xs font-bold text-[#00FF87]">
                ...
                <span>Манифест независимости wobuy<span className="text-[#00FF87] drop-shadow-[0_0_8px_#00FF87]">.</span></span>
              </div>

              <h2 className="text-2xl sm:text-3xl lg:text-4xl font-black tracking-tight text-white leading-tight">
                wobuy<span className="text-[#00FF87] drop-shadow-[0_0_8px_#00FF87]">.</span> на твоей стороне <br className="hidden sm:inline" />
                {/* а не на стороне продавцов.*/}
              </h2>

              <p className="text-sm sm:text-base text-slate-300 leading-relaxed">
                В wobuy<span className="text-[#00FF87] drop-shadow-[0_0_8px_#00FF87]">.</span> — только честная математика, сравнение Wildberries vs Ozon и выбор лучшего за 3 минуты.
              </p>
