        ...
        <div className="relative z-10 my-auto max-w-lg space-y-8">
          <div className="space-y-4">
            ...
            <p className="text-base leading-relaxed text-slate-400">
              Войди в личный кабинет, чтобы сохранять товары, видеть историю и работать с
              результатами поиска.
            </p>
          </div>
          ...
          >
            <div className="mb-8">
              ...
              <p className="mt-2 text-xs leading-relaxed text-slate-400 md:text-sm">
                Введи данные для входа в личный кабинет wobuy.
              </p>
            </div>
              ...
              <form onSubmit={handleLogin} className="space-y-4">
                <AnimatePresence mode="wait">
                  {errorMessage ? (
                    <motion.div
                      ...
                      exit={{ opacity: 0, y: -10 }}
                      className="flex items-start space-x-2.5 rounded-xl border border-red-500/20 bg-red-500/10 p-3.5 text-xs font-semibold text-red-400"
                    >
                ...
                <div className="space-y-2">
                  ...
                  <div className="group relative">
                    ...
                    />
                    <Mail className="absolute left-3.5 top-3.5 h-4 w-4 text-slate-500 group-focus-within:text-[#00FF87]" />
                  </div>
                </div>
                <div className="space-y-2">
                  ...
                  <div className="group relative">
                    <input
                      ...
                      className="w-full rounded-xl border border-white/10 bg-[#0D0F14]/70 py-3 pl-11 pr-4 text-sm text-white outline-none transition-all placeholder:text-slate-600 focus:border-[#00FF87]/50 focus:ring-1 focus:ring-[#00FF87]/20 disabled:opacity-50"
                    />
                    <Lock className="absolute left-3.5 top-3.5 h-4 w-4 text-slate-500 group-focus-within:text-[#00FF87]" />
                  </div>
                </div>
                <button
                  type="submit"
                  disabled={isLoading}
                  className="mt-6 flex w-full items-center justify-center space-x-2 rounded-xl bg-[#00FF87] py-3.5 text-sm font-extrabold text-black shadow-lg shadow-emerald-500/10 transition-all hover:bg-[#00E576] disabled:cursor-not-allowed disabled:bg-emerald-800 disabled:opacity-50"
                >
                  {isLoading ? (
                    <>
            ...
            <p className="mt-6 text-center text-xs font-medium text-slate-400">
              Новый пользователь?{" "}
              <Link href="/register" className="font-bold text-[#00FF87] hover:underline">
                Создать аккаунт бесплатно
              </Link>
            </p>
            <p className="mt-4 text-center">
              <Link href="/" className="text-xs font-semibold text-slate-500 hover:text-white">
                ← На главную
              </Link>
            </p>
          </motion.div>
