...
const MOCK_PRODUCTS: Product[] = [
  ...
  },
  {
    ...
    imageUrl:
      "https://images.unsplash.com/photo-1510312305653-8ed496efae75?w=500&auto=format&fit=crop&q=60",
  },
  {
    id: "prod-3",
      ...
      <main className="relative z-10 max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-8">
        ...
        <aside className="col-span-1 lg:col-span-3 bg-[#13161C]/50 border border-white/10 rounded-2xl p-5 backdrop-blur-md h-fit space-y-6">
          ...
          <div className="space-y-3">
            <div className="flex justify-between items-center text-xs font-bold">
              ...
              <span className="text-[#00FF87] bg-[#00FF87]/10 px-1.5 py-0.5 rounded">
                {minScore.toFixed(1)}
              </span>
            </div>
            <input
          ...
          <div className="space-y-2.5">
            ...
            <div className="grid grid-cols-1 gap-2">
              {[
                ...
                <button
                  key={opt.id}
                  onClick={() => setSortBy(opt.id as "score" | "price_asc" | "price_desc")}
                  className={`w-full text-left text-xs px-3.5 py-2.5 rounded-xl border font-semibold transition-all ${
                    sortBy === opt.id
                      ? "bg-white/10 border-white/20 text-white"
                      : "bg-white/5 border-transparent text-slate-400 hover:bg-white/8 hover:text-white"
        ...
        <section className="col-span-1 lg:col-span-9 space-y-4">
          ...
          <div className="flex items-center justify-between text-xs text-slate-400 px-1">
            <span>
              Найдено предложений: <strong className="text-white">{filteredProducts.length}</strong>
            </span>
            ...
            {filteredProducts.length > 0 ? (
                  ...
                  return (
                    <motion.div
                      ...
                      className={`relative rounded-2xl border bg-[#13161C]/50 transition-all duration-300 ${
                        isExpanded
                          ? "border-white/20 ring-1 ring-white/10 bg-[#13161C]/80"
                    ...
                    >
                      ...
                      <div className="p-5 flex flex-col justify-between h-full min-h-[300px]">
                          ...
                          <div className="flex flex-col items-end space-y-1">
                            ...
                            <div className="flex items-center space-x-2">
                              ...
                              <svg
                                width="60"
                                height="20"
                                className="stroke-slate-500 fill-none stroke-2"
                              >
                                <path
                                  d={getSvgPath(product.priceHistory)}
                                  stroke={
                                    product.priceHistory[0] > product.price ? "#00FF87" : "#EF4444"
                                  }
                                />
                              </svg>
                            </div>
                        ...
                        {/* Блок Анти-Фейка */}
                        <div
                          className={`mt-4 flex items-center space-x-2 px-3 py-2 rounded-xl border ${
                            isSuspicious
              ...
              <div className="flex flex-col items-center justify-center py-20 text-center bg-[#13161C]/30 border border-white/5 rounded-2xl p-6">
                ...
                <p className="text-sm text-slate-500 max-w-sm leading-relaxed">
                  Попробуйте снизить минимальный Score в фильтрах слева или изменить параметры
                  поиска.
                </p>
              </div>
            )}
